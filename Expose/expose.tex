...
Die oben beschriebene Ablehnung von eingereichtem Code auf Grund von Verstößen gegen Richtlinien führt zwar dazu, dass die Teammitglieder die vereinbarten Programmierrichtlinien mit der Zeit von sich aus einhalten, ohne immer darauf hingewiesen werden zu müssen.
...
Im Anschluss daran wird die Vorbereitungen für die Implementierung erläutert.
...
Entsprechend der ausgewählten Metriken wird der Code später untersucht.
